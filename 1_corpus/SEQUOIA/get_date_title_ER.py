...
"""
Script sert à générer le fichier ER_info.json, qui contient les dates et titres potentiels des articles utilisés dans PARSEME/Sequoia
...
with open("ER_info.json", "w", encoding="utf8") as sortie:
