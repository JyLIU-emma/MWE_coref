...
"""
Ce script sert à séparer le fichier sorti de corpus ANCOR à des sous-corpus:
...
for cle, valeur in dico.items():
    ...
    eslo_old_format[cle] = {"TYPE": cle, "Nombre_COREF": len(mwes_eslo),
                            "MWES": mwes_eslo}
    long_old_format[cle] = {"TYPE": cle, "Nombre_COREF": len(mwes_long),
                            "MWES": mwes_long}
    tele_old_format[cle] = {"TYPE": cle, "Nombre_COREF": len(mwes_tele),
                            "MWES": mwes_tele}
    short_old_format[cle] = {"TYPE": cle, "Nombre_COREF": len(mwes_short),
                             "MWES": mwes_short}
