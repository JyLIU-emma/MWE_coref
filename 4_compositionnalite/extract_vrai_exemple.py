...
def extract_exemple_from_jsonfile(files, corpus_global_name):
    ...
    Returns:
        new_liste (list): liste des dico de croisement valide dans tout
                          le corpus
    """
        ...
        for cle, valeur in dico.items():
            ...
            for i_new in valeur["MWES"]:
                ...
                if valid == "vrai":
                    ...
                    i_new['expr_cnt'] = Counter(i_new['LEMMES'])
...
def get_mwe_diff(new_liste, corpus_name):
    """
    Unifier différentes formes d'une MWE, générer un fichier de sortie
    *_croisement_valid.json
    """
    dico_mwe = {}
    for i in new_liste:
        expr = i['expr_cnt']
